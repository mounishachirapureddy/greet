...
async function sendBirthdayGreetings(req,res) {
    ...
    const templeImage = qrCodesAndTempleImages[3];
     ...
     var pay_base64=paypal.data.toString('base64')
     var zelle_base64=zelle.data.toString('base64')
     var temple_banner_base64=templeBanner.data.toString('base64')
     var tempel_image_base64=templeImage.data.toString('base64')
    ...
    const mailOptions = {
      ...
      attachments:[  
       ...
       // {filename: templeImage.originalname, path: template.templeImage, cid: 'templeImage',  contentDisposition: 'inline',},
        ...
        {filename:paypal.originalname,content:pay_base64,encoding:'base64',cid:'paypal',contentType:'image/png',contentDisposition:'inline'},
        {filename:zelle.originalname,content:zelle_base64,encoding:'base64',cid:'zelle',contentType:'image/png',contentDisposition:'inline'},
        {filename:templeBanner.originalname,content:temple_banner_base64,encoding:'base64',cid:'templeBanner',contentType:'image/png',contentDisposition:'inline'},
        {filename:templeImage.originalname,content:tempel_image_base64,encoding:'base64',cid:'templeImage',contentType:'image/png',contentDisposition:'inline'},
